...
POLICY_REVIEWS = {
 'https://www.intigriti.com/programs/capitalcom/capitalcom/detail': {'reviewed_on':'2026-09-24','note':'Priority web/API candidate. Listed maximum EUR 15,000 is a possible ceiling, not expected earnings. The policy lists capital.com and open-api.capital.com, with asset-specific rewards and exclusions. Automated tooling is capped at 10 requests/second. Scanner-only warnings need manual validation and reproducible impact. Next: confirm current exact asset rules and reporting eligibility, then prepare your own test account and synthetic private data for a permitted test. No replacement scan is enabled by shortlisting.','sources':['https://app.intigriti.com/programs/capitalcom/capitalcom/detail']},
