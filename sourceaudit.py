...
FILES = ('app.py','engine.py','supervisor.py','workflow.py','workqueue.py','casework.py','connections.py','reporting.py','sourceaudit.py','codeflow.py','dependencies.py','rewards.py','validation.py','accesscheck.py','capitaldemo.py','gitlabcheck.py')
MAX_BYTES=128000
